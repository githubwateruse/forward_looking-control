# -*- coding: utf-8 -*-
"""
Created on Wed May 14 07:09:52 2025
...
""" 
# Neural network for mapping the historical rainfall data to the future control actions.
# The model learns the relationship between past rainfall data (as well as current upstream node depths) and the future control actions of the orifices.
"""
...
def dataset_extraction(filename):
    ...
    data_path_name = "C:/xiaoxin backup/end-to-end control/Astlingen simulation/rainfall_action_datasets/rainfall_action_" + filename + ".xlsx"
