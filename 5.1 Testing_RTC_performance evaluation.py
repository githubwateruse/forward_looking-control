...
def get_reward_per_year(network_params, testing_year):
    ...
    for t in range (EP_LEN):
        Action =  get_action(network_params, Storm_state)
...
if __name__ == "__main__":
    ...
    workbook_curve = xlsxwriter.Workbook('Performance comparison/RTC_Overall' +'.xlsx')
    ...
    for mmm in range (len(TESTING_YEARS)):
        ...
        workbook_year = xlsxwriter.Workbook('Performance comparison/RTC_Overall_year ' + str(testing_year) +'.xlsx')
